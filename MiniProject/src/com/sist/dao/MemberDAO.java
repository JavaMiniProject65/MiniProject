...
public class MemberDAO {
   ...
   public void memberJoin(MemberVO vo)
   {
       ...
       {
           getConnection();
           // ★ 수정: 컬럼명 명시하여 순서/누락 오류 방지, NAME 자리 확정
           String sql="INSERT INTO project_member "
                     +" (id, pwd, name, sex, post, addr1, addr2, phone, regdate) "
                     +" VALUES(?,?,?,?,?,?,?,?,SYSDATE)";
           ps=conn.prepareStatement(sql);
           ps.setString(1, vo.getId());
           ps.setString(2, vo.getPwd());
           ps.setString(3, vo.getName());   // ★ NAME 바인딩 확실
           ps.setString(4, vo.getSex());
           ps.setString(5, vo.getPost());
           ps.setString(6, vo.getAddr1());
           ps.setString(7, vo.getAddr2());
           ps.setString(8, vo.getPhone());  // ★ JoinForm과 get/set 키 통일
           ps.executeUpdate();
       }catch(Exception ex)
       {
           ex.printStackTrace();
